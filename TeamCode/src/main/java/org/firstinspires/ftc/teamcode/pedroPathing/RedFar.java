    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            ToScoreInitial = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(88, 8), new Pose(88, 21)))
                    .setLinearHeadingInterpolation(0, 0)
                    .build();

            toAlignClose = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(88, 21), new Pose(88, 35)))
                    .setLinearHeadingInterpolation(0, 0)
                    .build();

            toGrabClose = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(88, 35), new Pose(130, 35)))
                    .setLinearHeadingInterpolation(0, 0)
                    .setTangentHeadingInterpolation()
                    .build();

            toScoreClose = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(130, 35), new Pose(88, 21)))
                    .setLinearHeadingInterpolation(0, 0)
                    .build();
